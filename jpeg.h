 ...
 *
 * All its headers merged.  jinclude.h must stay ahead of jpeglib.h, it is what
 * pulls <stdio.h> in for the FILE * prototypes.  Everything internal is behind
 * JPEG_INTERNALS so rfbproto.c sees only the API.  jconfig.h is the
 * per-platform config, jmorecfg.h the capability switches. */
...
/* ======== jpeg-6b: jpegint.h ======== */
#ifndef JPEGINT_H_GUARD
#define JPEGINT_H_GUARD
/*
 * jpegint.h
 *
 * Copyright (C) 1991-1997, Thomas G. Lane.
...
/* ======== jpeg-6b: jdhuff.h ======== */
#ifndef JDHUFF_H_GUARD
#define JDHUFF_H_GUARD
/*
 * jdhuff.h
 *
 * Copyright (C) 1991-1997, Thomas G. Lane.
...
/* ======== jpeg-6b: jmemsys.h ======== */
#ifndef JMEMSYS_H_GUARD
#define JMEMSYS_H_GUARD
/*
 * jmemsys.h
 *
